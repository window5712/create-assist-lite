...
const engagementData = [
  { date: "Mon", engagement: 4.2, posts: 5 },
  { date: "Tue", engagement: 3.8, posts: 3 },
  { date: "Wed", engagement: 5.1, posts: 7 },
  { date: "Thu", engagement: 4.7, posts: 4 },
  { date: "Fri", engagement: 6.2, posts: 8 },
  { date: "Sat", engagement: 5.8, posts: 6 },
  { date: "Sun", engagement: 4.9, posts: 5 },
];
...
export const DashboardAnalytics = () => {
  ...
  const fetchAnalyticsData = async () => {
    // If no organization, just use default data
    if (!organization) {
      setAnalyticsData({
        totalPosts: 0,
        publishedPosts: 0,
  ...
  const fetchJobLogs = async () => {
    // If no organization, just set empty logs and stop loading
    if (!organization) {
      setJobLogs([]);
      setLoading(false);
      return;
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Monitor your posting performance and track engagement metrics
          </p>
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Daily engagement rate and post count
            </CardDescription>
          </CardHeader>
          <CardContent>
