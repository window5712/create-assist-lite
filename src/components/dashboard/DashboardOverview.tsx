    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {kpiCards.map((kpi, index) => (
          <Card key={index} className="border-border bg-card text-card-foreground hover:shadow-glow transition-all duration-300">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card className="border-border bg-card">
          ...
          <CardContent className="space-y-4">
            {recentPosts.map((post) => (
              <div key={post.id} className="flex items-start space-x-3 p-3 border border-border rounded-lg bg-card/50 hover:bg-accent/50 transition-colors">
        ...
        <Card className="border-border bg-card">
          <CardHeader>
            <CardTitle className="text-card-foreground">Platform Health</CardTitle>
            <CardDescription>
          ...
          <CardContent className="space-y-4">
            {[
              ...
              <div key={index} className="flex items-center justify-between p-3 border border-border rounded-lg bg-card/50 hover:bg-accent/50 transition-colors">
